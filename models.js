...
models.classify = [
  ...
  { name: 'ImageNet EfficientNet B5', modelPath: 'models/efficientnet-b5/model.json', score: 0.2, topK: 3, slice: 0, tensorSize: 456, offset: 0, classes: 'assets/ImageNet-Labels1000.json' },
...
models.person = [
  { name: 'FaceAPI TinyYolo', modelPath: 'models/faceapi/', type: 'tinyFaceDetector', score: 0.3, size: 416 },
];
...
models.classify_inactive = [
  ...
  { name: 'iNaturalist Food MobileNet v1', modelPath: 'models/inaturalist/food/model.json', score: 0.38, scoreScale: 500, topK: 1, useFloat: false, tensorSize: 192, classes: 'assets/iNaturalist-Food-Labels.json', offset: 0 },
  { name: 'iNaturalist Plants MobileNet v2', modelPath: 'models/inaturalist/plants/model.json', score: 0.2, scoreScale: 200, topK: 1, useFloat: false, tensorSize: 224, classes: 'assets/iNaturalist-Plants-Labels.json', offset: 0, background: 2101 },
  { name: 'iNaturalist Birds MobileNet v2', modelPath: 'models/inaturalist/birds/model.json', score: 0.25, scoreScale: 200, topK: 1, useFloat: false, tensorSize: 224, classes: 'assets/iNaturalist-Birds-Labels.json', offset: 0, background: 964 },
  { name: 'iNaturalist Insects MobileNet v2', modelPath: 'models/inaturalist/insects/model.json', score: 0.3, scoreScale: 200, topK: 1, useFloat: false, tensorSize: 224, classes: 'assets/iNaturalist-Insects-Labels.json', offset: 0, background: 1021 },
  { name: 'NSFW MobileNet v2', modelPath: 'models/nsfw-mobilenet-v2/model.json', score: 0.1, topK: 4, scoreScale: 1, slice: 0, tensorSize: 244, offset: 0, useFloat: true, reshape: -1, modelType: 'graph', classes: 'assets/NSFW-Labels.json' },
  ...
  { name: 'NSFW Mini', modelPath: 'models/nsfw-mini/model.json', score: 0.7, topK: 4, scoreScale: 2, slice: 0, useFloat: false, tensorSize: 244, offset: 0, modelType: 'layers', classes: 'assets/NSFW-Labels.json' },
  { name: 'Places365 VGG16 Standard', modelPath: 'models/places365-vgg16-notop/model.json', modelType: 'layers', scoreScale: 100, useFloat: false, classes: 'assets/Places365-Standard-Labels.json' },
...
models.detect_inactive = [
  { name: 'CoCo SSD v1', modelPath: 'models/cocossd-v1/model.json', score: 0.4, topK: 6, overlap: 0.5, exec: modelDetect.detectCOCO },
  ...
  { name: 'OpenImages RCNN/Inception-ResNet v2', modelPath: 'models/rcnn-inception-resnet-v2/model.json', score: 0.2, topK: 6, useFloat: true, classes: 'assets/OpenImage-Labels.json', exec: modelDetect.detectSSD },
];
