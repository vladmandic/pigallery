...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@tensorflow/tfjs-converter'), require('@tensorflow/tfjs-core'))
    : typeof define === 'function' && define.amd ? define(['exports', '@tensorflow/tfjs-converter', '@tensorflow/tfjs-core'], factory)
      : (factory((global.mobilenet = {}), global.tf, global.tf));
}(this, ((exports, tfconv, tf) => {
  /*! *****************************************************************************
  ...
  function load(modelConfig) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      let _a; let _b; let versionStr; let alphaStr; let inputMin; let inputMax; let
        mobilenet;
  ...
  let MobileNetImpl = (function () {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 3:
              ...
              _c.label = 4;
            case 4:
              result = tf.tidy(() => _this.model.predict(tf.zeros([1, IMAGE_SIZE, IMAGE_SIZE, 3])));
    ...
    MobileNetImpl.prototype.infer = function (img, embedding) {
      ...
      return tf.tidy(() => {
        ...
        const normalized = img.toFloat().mul(_this.normalizationConstant).add(_this.inputMin);
        ...
        let result;
        if (embedding) {
          const embeddingName = EMBEDDING_NODES[_this.version];
          const internal = _this.model.execute(batched, embeddingName);
          result = internal.squeeze([1, 2]);
        } else {
          const logits1001 = _this.model.predict(batched);
  ...
  function getTopKClasses(logits, topK) {
    return __awaiter(this, void 0, void 0, function () {
      let softmax; let values; let valuesAndIndices;
      let i; let topkValues; let topkIndices;
